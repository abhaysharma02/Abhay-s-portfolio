...
export default function HeroSection() {
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center pt-32 pb-20 overflow-hidden">
            {/* Background Gradients - Adjusted for softer Apple style */}
            <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-white/[0.03] blur-[100px] rounded-full pointer-events-none mix-blend-screen animate-blob" />
            <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-blue-500/[0.02] blur-[120px] rounded-full pointer-events-none mix-blend-screen animate-blob-reverse" />
            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center z-10 w-full flex-grow justify-center">
                <motion.div
                    ...
                    className="w-28 h-28 md:w-32 md:h-32 rounded-full p-[2px] bg-gradient-to-b from-white/20 to-transparent mb-8 shadow-2xl relative"
                >
                    <div className="absolute inset-0 rounded-full bg-white/20 blur-xl opacity-30"></div>
                    <img
                        src="https://github.com/abhaysharma02.png"
                ...
                >
                    ...
                    <span className="text-xs font-semibold text-neutral-400 tracking-widest uppercase">Available for Opportunities</span>
                </motion.div>
                ...
                <motion.h2
                    ...
                    className="text-2xl md:text-3xl font-medium tracking-tight text-neutral-300 mb-6 text-gradient"
                >
